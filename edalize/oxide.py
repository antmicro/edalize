...
class Oxide(Edatool):
    ...
    def get_doc(cls, api_ver):
        if api_ver == 0:
            ...
            return {'description' : "Project Oxide enables a fully open-source flow for FPGAs using Yosys for Verilog synthesis and nextpnr for place and route",
                    'members' : options['members'],
                    'lists'   : options['lists']}

    def configure_main(self):
        #Pass oxide tool options to yosys and nextpnr
